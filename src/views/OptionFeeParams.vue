	...
	<section>
		...
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
			<el-form :inline="true" :model="filters">
				...
				<el-form-item>
					<el-button type="primary" v-on:click="getOptionFeeParams">查询</el-button>
				</el-form-item>
				<el-form-item>
		...
		<!-- 列表 -->
		<el-table :data="option_fee_params" highlight-current-row v-loading="listLoading" @selection-change="onSelectionChanged"
		 @sort-change="onSortChanged" :cell-style="cellStyle" :header-cell-style="headerCellStyle" style="width: 100%;">
			...
			<el-table-column prop="sse_ratio" label="上交所佣金" width="140" sortable="custom">
			</el-table-column>
		...
		<el-dialog title="编辑" :visible.sync="editFormVisible" :close-on-click-modal="false">
			<el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
				...
				<el-form-item label="上交所佣金" prop="sse_ratio">
					<el-input v-model="editForm.sse_ratio" auto-complete="off"></el-input>
				</el-form-item>
			</el-form>
		...
		<el-dialog title="新建" :visible.sync="addFormVisible" :close-on-click-modal="false">
			<el-form :model="addForm" label-width="80px" :rules="addFormRules" ref="addForm">
				...
				<el-form-item label="上交所佣金" prop="sse_ratio">
					<el-input v-model="addForm.sse_ratio" auto-complete="off"></el-input>
				</el-form-item>
			</el-form>
			<div slot="footer" class="dialog-footer">
...
<script>
	...
	import {
		getOptionFeeParamsPage,
		addOptionFeeParam,
		editOptionFeeParam,
		deleteOptionFeeParam,
		deleteOptionFeeParams,
		getAccountsPage,
	} from '../api/api';
	...
	export default {
		...
		methods: {
			...
			handleCurrentChange: function(val) {
				this.page = val;
				this.getOptionFeeParams();
			},
			getOptionFeeParams: function() {
				let para = {
					page: this.page,
				...
				//NProgress.start();
				getOptionFeeParamsPage(para)
					.then((res) => {
						this.total = res.data.total;
						this.option_fee_params = res.data.data;
